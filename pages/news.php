...
<body class="news-body">
  ...
  <div class="news-section">
    <section>
      ...
      <div class="news-card">
        <a href="info6.html" style="border-radius: inherit">
    ...
    <section>
      <div class="news-details">
        ...
        <p style="line-height: 2">
          ...
          TOOL. INTRODUCING THE MERCEDES-BENZ 280SL, A STAR FROM THE '70S THAT
          ...
          <br />
          <br />
          1 OUT OF 280 CONVERTIBLES AVAILABLE NOW.
        </p>
      </div>
      <div class="news-card">
        <a href="info5.html" style="border-radius: inherit">
          <div class="image-container" style="height: 600px; width: 500px">
            <img src="../assets/news/mercedes-280sl.jpg" alt="mercedes-280sl" />
          </div>
          <div class="news-card-details">
            <h2>280 SL</h2>
            <p>Discover...</p>
  ...
  <div class="news-section">
    <section>
      ...
      <div class="news-card">
        <a href="info2.html" style="border-radius: inherit">
          <div class="image-container">
            <img
  ...
  <div class="news-section">
    <section>
      ...
      <div class="news-card">
        <a href="info4.html" style="border-radius: inherit">
          <div class="image-container" style="height: 600px; width: 500px">
